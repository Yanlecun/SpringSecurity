...
public class SpELTest {
    ...
    @DisplayName("4. Spring Context 테스트 ")
    @Test
    void test_4() {
        ...
        assertTrue(parser.parseExpression("over(170)").getValue(context,
                Boolean.class));
        assertFalse(parser.parseExpression("#horse.over(170)").getValue(context,
                Boolean.class));
        assertTrue(parser.parseExpression("@person.over(170)").getValue(context,
                Boolean.class));
        assertFalse(parser.parseExpression("@nancy.over(170)").getValue(context,
                Boolean.class));
